...
jQuery.Class("Vtiger_Detail_Js",{
	...
	detailViewRecentActivityHistoryTabLabel : 'Activity History',
	...
	registerEvents : function(){
		...
		detailContentsHolder.on('click','.moreRecentActivities', function(){
			var recentActivitiesTab = thisInstance.getTabByLabel(thisInstance.detailViewRecentActivityHistoryTabLabel);
