...
class Calendar_QuickEdit_View extends Vtiger_Edit_View {

	function __construct() {
		parent::__construct();
		$this->exposeMethod('checkReordType');
		$this->exposeMethod('showCalendarPopup');
	}

	protected function preProcessTplName(Vtiger_Request $request) {
		return 'QuickIndexViewPreProcess.tpl';
	}

	public function  showCalendarPopup(Vtiger_Request $request) {
