...
$db->pquery("update vtiger_field set sequence = 3 where fieldname = 'last_name'",array());
$db->pquery("update vtiger_field set sequence = 4 where fieldname = 'first_name'",array());
...
$field->table = $accountModule->basetable;
$field->column = 'last_action_date';
...
// 活動のブロック順番変更
$sql = "update vtiger_blocks set sequence = 4 where tabid = 16 and blocklabel = 'LBL_REMINDER_INFORMATION'";
$db->pquery($sql,array());

$sql = "update vtiger_blocks set sequence = 5 where tabid = 16 and blocklabel = 'LBL_RECURRENCE_INFORMATION'";
$db->pquery($sql,array());

$sql = "update vtiger_blocks set sequence = 2 where tabid = 16 and blocklabel = 'LBL_RELATED_TO'";
$db->pquery($sql,array());

$sql = "update vtiger_blocks set sequence = 3 where tabid = 16 and blocklabel = 'LBL_DESCRIPTION_INFORMATION'";
$db->pquery($sql,array());
