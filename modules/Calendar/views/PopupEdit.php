...
Class Calendar_PopupEdit_View extends Calendar_Edit_View {
	...
	protected function preProcessTplName(Vtiger_Request $request) {
		return 'PopupIndexViewPreProcess.tpl';
	}
	...
	function Events($request, $moduleName) {
		...
		$viewer->view('PopupEditView.tpl', "Calendar");
	}
	...
	function getHeaderScripts(Vtiger_Request $request) {
		...
		$jsFileNames = array(
			...
			"modules.$moduleName.resources.PopupEdit",
		);
	...
	function Calendar($request, $moduleName) {
		...
		$viewer->view('PopupEditView.tpl', "Events");
	}
}