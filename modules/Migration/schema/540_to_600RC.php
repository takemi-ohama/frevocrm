...
$currency_decimals_field->defaultvalue = '0';
...
$itemFieldsName = array('productid','quantity','listprice','comment','discount_amount','discount_percent','tax1');
$itemFieldsLabel = array('Item Name','Quantity','List Price','Item Comment','Item Discount Amount','Item Discount Percent','Tax1');
$itemFieldsTypeOfData = array('V~M','V~M','V~M','V~O','V~O','V~O','V~O','V~O','V~O');
$itemFieldsDisplayType = array('10','7','19','19','7','7','83');
...
$truncateTrailingZeros->defaultvalue = 1;
...
Migration_Index_View::ExecuteQuery("INSERT INTO vtiger_no_of_currency_decimals (`no_of_currency_decimalsid`, `no_of_currency_decimals`, `sortorderid`, `presence`) VALUES ('1', '0', '1', '1');", array());
...
Migration_Index_View::ExecuteQuery('UPDATE vtiger_field SET defaultvalue=? WHERE tablename=? AND fieldname= ? ', array('Sunday', 'vtiger_users', 'dayoftheweek'));
