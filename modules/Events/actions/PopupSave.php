...
class Events_PopupSave_Action extends Calendar_PopupSave_Action {
	...
	public function saveRecord($request) {
		...
		Events_Util_Helper::copyCalendarRecord($recordModel);
		Events_Util_Helper::updateLastActionDate($recordModel->getId(), $request);
