	...
	<div class="container-fluid editViewContainer">
		...
		{/if}
			...
			<div>
					...
					<table class="table table-bordered marginLeftZero">
						{if $BLOCK_FIELDS|@count gt 0}
							<tr class="listViewActionsDiv">
								<th colspan="1">{vtranslate($BLOCK_LABEL, $MODULE)}</th>
							</tr>
							<tr>
							...
							{foreach key=FIELD_NAME item=FIELD_MODEL from=$BLOCK_FIELDS name=blockfields}
								...
								<tr>
								<td class="fieldValue {$WIDTHTYPE}" {if $FIELD_MODEL->get('uitype') eq '19'} colspan="1" {assign var=COUNTER value=$COUNTER+1} {/if}>
				...
				<table class="table table-bordered marginLeftZero">
					<tr class="listViewActionsDiv">
						<th colspan="1">{vtranslate('LBL_TAG_CLOUD_DISPLAY', $MODULE)}</th>
					</tr>
					<tr>
