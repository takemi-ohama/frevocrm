...
{* <script> resources below *}
	...
	{/foreach}
	{if $MODULE_NAME eq 'Calendar' && $VIEW eq 'MobileList' }
		{*<script type="text/javascript" src="layouts/vlayout2/modules/Calendar/resources/CalendarView.js"></script>*}
		{*<script type="text/javascript" src="layouts/vlayout2/modules/Calendar/resources/SharedCalendarView.js"></script>*}
