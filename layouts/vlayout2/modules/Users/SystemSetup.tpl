            ...
            <div class="container-fluid page-container">
                ...
                <div class="row-fluid main-container">
                    <div class="span12 inner-container">
                        <div class="row-fluid">
                            <div class="span8">
								<h3 style="display: inline-block;float:left;">オプションモジュール選択</h3>
								<p style="display: inline-block;float:left;margin-top:4px;">&nbsp;&nbsp;インストールしたいモジュールオプションを選択してください</p>
                            </div>
							<div class="span4">
								<div class="pull-right"><label for="checkbox-1" style="vertical-align:bottom;margin:0;margin-top:8px\9;margin-left:10px\9;font-size:15px;"><strong>すべて選択</strong></label> <input type="checkbox" name="selectAll" class="selectAll"/><div class="chkbox"></div></div>
							</div>
                        </div>
                        <hr>
