...
$languageStrings = array(
	...
	'LBL_CONFIGURE_DEPENDENCY_HELP_2' => '依存元フィールドの他の定義リスト値のマッピングを参照するか、または変更したい場合は、<b>右端にある[依存元値の選択]</b>のボタンをクリックし依存元の定義リスト値を選択します',
	...
	'PickListDependency' => '定義リスト依存関係',
	'Module' => 'モジュール',
	'Source Field' => '依存元フィールド',
	'Target Field' => '依存先フィールド',
	);
